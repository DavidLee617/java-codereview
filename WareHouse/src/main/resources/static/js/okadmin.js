  ...
  $.ajax({
    ...
    success : function(result) {
      if(result.data == 1){
        ...
        var okTab1 = layui.okTab({
          url: "data/wareNavs.json",
          openTabNum: 30,
          parseData: function (data) {
            return data;
          }
        ...
        var okTab2 = layui.okTab({
          url: "data/salesNavs.json",
          openTabNum: 30,
          parseData: function (data) {
            return data;
          }
        ...
        var okTab3 = layui.okTab({
          url: "data/inportNavs.json",
          openTabNum: 30,
          parseData: function (data) {
            return data;
          }
